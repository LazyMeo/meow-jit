...
//     Value(meow::core::MeowObject* o): data_(o) {}
...
//     inline meow::core::MeowObject* as_object() const { return std::get<Object>(data_); }
...
//     inline meow::core::MeowObject* const* as_if_object() const noexcept { return std::get_if<Object>(&data_); }
...
//     inline meow::core::MeowObject** as_if_object() noexcept { return std::get_if<Object>(&data_); }
// };
...
//     Value(meow::core::MeowObject* o): type_(ValueType::Object) { data_.obj = o; }
...
//     inline meow::core::MeowObject* as_object() const noexcept { return data_.obj; }
// };
