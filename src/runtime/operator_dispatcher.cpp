...
//             case VT::String:    return v.get<String>()->empty();
//             case VT::Array:  {
...
//     binaryOps[{ADD, VT::String,  VT::String }] = [this](const Value& l, const Value& r){
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r)));
//     };
//     binaryOps[{ADD, VT::String,  VT::Int }] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r)));
//     };
//     binaryOps[{ADD, VT::Int,  VT::String }] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r)));
//      };
//     binaryOps[{ADD, VT::String,  VT::Real}] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r))); 
//     };
//     binaryOps[{ADD, VT::Real, VT::String }] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r))); 
//     };
//     binaryOps[{ADD, VT::String,  VT::Bool}] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r))); 
//     };
//     binaryOps[{ADD, VT::Bool, VT::String }] = [this](const Value& l, const Value& r){ 
//         return Value(memoryManager->newObject<ObjString>(toString(l) + toString(r))); 
//     };
...
//     binaryOps[{BIT_AND, VT::Bool, VT::Bool}] = [](const Value& l, const Value& r){ return Value(static_cast<int>(l.get<Bool>()) & static_cast<int>(r.get<Bool>())); };
//     binaryOps[{BIT_OR,  VT::Bool, VT::Bool}] = [](const Value& l, const Value& r){ return Value(static_cast<int>(l.get<Bool>()) | static_cast<int>(r.get<Bool>())); };
...
//     binaryOps[{EQ,  VT::String,  VT::String }] = [](const Value& l, const Value& r){ return Value(l.get<String>() == r.get<String>()); };

//     binaryOps[{EQ,  VT::Null, VT::Null}] = [](const Value&, const Value&){ return Value(true); };


//     std::vector<VT> allTypes = {
//         VT::Null, VT::Bool, VT::Int, VT::Real, VT::String,
...
//     binaryOps[{NEQ, VT::String,  VT::String }] = [](const Value& l, const Value& r){ return Value(l.get<String>() != r.get<String>()); };
...
//     binaryOps[{LT, VT::String, VT::String}] = [](const Value& l, const Value& r){ 
//         return Value(l.get<String>()->utf8() <  r.get<String>()->utf8()); 
//     };
//     binaryOps[{LE, VT::String, VT::String}] = [](const Value& l, const Value& r){ 
//         return Value(l.get<String>()->utf8() <= r.get<String>()->utf8()); 
//     };
//     binaryOps[{GT, VT::String, VT::String}] = [](const Value& l, const Value& r){ 
//         return Value(l.get<String>()->utf8() >  r.get<String>()->utf8()); 
//     };
//     binaryOps[{GE, VT::String, VT::String}] = [](const Value& l, const Value& r){ 
//         return Value(l.get<String>()->utf8() >= r.get<String>()->utf8()); 
//     };
...
//                 case VT::String:    return Value(r.get<String>()->empty());
//                 case VT::Array:  {
//                     auto arr = r.get<Array>();
//                     return Value(!(arr && !arr->empty()));
//                 }
//                 case VT::Object: {
//                     auto obj = r.get<Object>();
//                     return Value(!(obj && !obj->empty()));
//                 }
//                 case VT::Upvalue:
//                 case VT::Function:
//                 case VT::Class:
